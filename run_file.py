...
# from Lab12.lab_12 import selection_sort
...
# testing_sorting(heap_sort, max_len=1000, testing_amount=20)
# testing_sorting(merge_sort, max_len=1000, testing_amount=20)
# testing_sorting(quick_sort, max_len=1000, testing_amount=20)
# testing_sorting(selection_sort, max_len=1000, testing_amount=20)
