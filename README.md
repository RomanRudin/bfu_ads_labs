...
12. [x] [External multiphase merge sort (Внешняя многофазная сортировка слиянием)](/Semester_1/Labs/Lab12/lab_12.py)
13. [x] [Хэш-табоица с открытой адресацией](/Semester_1/Labs/Lab13/lab_13.py)
