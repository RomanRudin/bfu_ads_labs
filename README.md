...
[Вордовский документ с тем же текстом лабами](/docs//Zadania_1_semestr_2024-2025.docx)

1. "Задача о скобках"https://yandex.ru/images/search?text=qsort&parent-reqid=1728334611474883-1683801220411920485-balancer-l7leveler-kubr-yp-klg-314-BAL&from=tabbar
...
Что соответствует
![Screenshot from file](/images_for_readme/1.png)
