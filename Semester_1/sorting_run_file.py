...
if __name__ == "__main__":
    ...
    testing_external_sorting(external_multiphase_sort, r"\Labs\Lab12\Data", max_len=100_000, min_max_elem=100_000, testing_amount=20, clean_files=False, run_size=1_000)
