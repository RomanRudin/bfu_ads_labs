...
1. [x] [Алгоритм проверки точек на выпуклый многоугольник]()
2. [x] [Алгоритм проверки точек на вершины вложенных треугольников]()
3. [x] [Алгоритм поиска по образцу с помощью конечного автомата]()
4. [x] [Алгоритм Кнута-Морриса-Пратта для поиска по образ]()
5. [x] [Алгоритм Бойера-Мура для поиска по образцу]()
6. [x] [Алгоритм Рабина для поиска по образцу]()
7. [X] [Задача о самом большом подмассиве]()
8. [X] [Проблема размена монет]()
9. [X] [Задача коммивояжера]()
10. [x] [Задача о бросании яиц]()
11. [x] [Задача о раскраске графа]()
12. [x] [Дискретная задача о рюкзаке]()
13. [X] [Задача о раскладке по ящикам]()
